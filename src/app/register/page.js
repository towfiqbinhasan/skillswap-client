...
export default function RegisterPage() {
  const [form, setForm] = useState({
    name: '', email: '', password: '', image: '', role: 'client'
  });
 ...
 const validatePassword = (pass) => {
  ...
  return (
    <div style={{
      ...
      background: '#f8fafc', padding: '2rem 0'
    }}>
      <div style={{
        ...
        <p style={{ color: '#64748b', marginBottom: '2rem' }}>Join SkillSwap today</p>
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ marginBottom: '1rem' }}>
            <label style={{ display: 'block', marginBottom: '0.4rem', fontWeight: '600', color: '#374151' }}>Full Name</label>
            <input
              type="text" required
              value={form.name}
          ...
          <div style={{ marginBottom: '1rem' }}>
            <label style={{ display: 'block', marginBottom: '0.4rem', fontWeight: '600', color: '#374151' }}>Profile Image URL</label>
            <input
              type="url"
              value={form.image}
          ...
          <div style={{ marginBottom: '1.5rem' }}>
            <label style={{ display: 'block', marginBottom: '0.4rem', fontWeight: '600', color: '#374151' }}>Account Type</label>
            <div style={{ display: 'flex', gap: '1rem' }}>
              {['client', 'freelancer'].map(r => (
                <label key={r} style={{
                  display: 'flex', alignItems: 'center', gap: '0.5rem',
                  cursor: 'pointer', color: '#374151', textTransform: 'capitalize'
                }}>
                  <input
        ...
        <button onClick={handleGoogleSignup} type="button" style={{
